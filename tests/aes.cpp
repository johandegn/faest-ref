...
BOOST_AUTO_TEST_CASE(test_extend_witness_aes128) {
  ...
  uint8_t* w = (uint8_t*)malloc((params.faest_param.l + 7) / 8);
  uint8_t* extwit =
      aes_extend_witness(aes_ctr_128_tv::key.data(), aes_ctr_128_tv::in.data(), &params, w);
...
BOOST_AUTO_TEST_CASE(test_extend_witness_rijndael_em128) {
  ...
  uint8_t* w = (uint8_t*)malloc((params.faest_param.l + 7) / 8);
  uint8_t* extwit =
      aes_extend_witness(rijndael_em_128_tv::key.data(), rijndael_em_128_tv::in.data(), &params, w);
...
BOOST_AUTO_TEST_CASE(test_extend_witness_aes192) {
  ...
  uint8_t* w = (uint8_t*)malloc((params.faest_param.l + 7) / 8);
  uint8_t* extwit =
      aes_extend_witness(aes_ctr_192_tv::key.data(), aes_ctr_192_tv::in.data(), &params, w);
...
BOOST_AUTO_TEST_CASE(test_extend_witness_rijndael_em192) {
  ...
  uint8_t* w = (uint8_t*)malloc((params.faest_param.l + 7) / 8);
  uint8_t* extwit =
      aes_extend_witness(rijndael_em_192_tv::key.data(), rijndael_em_192_tv::in.data(), &params, w);
...
BOOST_AUTO_TEST_CASE(test_extend_witness_aes256) {
  ...
  uint8_t* w = (uint8_t*)malloc((params.faest_param.l + 7) / 8);
  uint8_t* extwit =
      aes_extend_witness(aes_ctr_256_tv::key.data(), aes_ctr_256_tv::in.data(), &params, w);
...
BOOST_AUTO_TEST_CASE(test_extend_witness_rijndael_em256) {
  ...
  uint8_t* w = (uint8_t*)malloc((params.faest_param.l + 7) / 8);
  uint8_t* extwit =
      aes_extend_witness(rijndael_em_256_tv::key.data(), rijndael_em_256_tv::in.data(), &params, w);
